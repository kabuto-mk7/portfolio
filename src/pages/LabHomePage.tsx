...
export function LabHomePage() {
  ...
  return (
    <main
      ...
      "
    >
      {/* Feature image — fixed overflow + responsive */}
      <div className="mb-6">
        <img
          ...
          className="
            ...
            border border-[#4a5a45]
            shadow-[0_0_0_1px_#2d362b]
            object-cover
            max-w-full
          "
          loading="eager"
      ...
      <Window title="Launcher">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="md:col-span-2 space-y-6">
            <Panel title="About" rightTag="readme.md">
              <div className="space-y-3 text-sm opacity-80 leading-relaxed">
                <p>
                  ...
                  was working putting computers in people's brains. Most of my time
                  goes into making things: hardware mods, camera work, code, and
                  builds that end up useful.
                </p>
                <p>
                  This is the lab. Build logs, e-sports kit + results, and projects
              ...
              {SECTIONS_TOP.map((s) => {
                ...
                return (
                  <a
                    ...
                    className="
                      group relative rounded-[6px]
                      border border-[#5a6a55]
                      bg-[linear-gradient(180deg,#414c40_0%,#313b2f_100%)]
                      px-4 py-3
                      shadow-[inset_0_1px_0_#566552,0_1px_0_#20281f]
                      hover:border-[var(--primary)]
                      hover:shadow-[inset_0_1px_0_var(--primary),0_0_0_2px_rgba(215,230,182,0.12)]
                      transition-all
                    "
                  >
            ...
            {/* Visitor counter — mobile-safe scaling & wrapping */}
            <div className="mt-4 flex flex-col items-center">
              <div
                className="
                  flex items-center justify-center
                  text-sm flex-wrap gap-x-2 gap-y-2
                "
              >
                <span className="opacity-80 whitespace-nowrap">you are the</span>
                <img
                  src={`${COUNTER_SRC}${cacheBust ? `&t=${cacheBust}` : ""}`}
                  alt="site hit counter"
                  className="
                    mx-2
                    h-16 xs:h-20 sm:h-24 md:h-28 lg:h-36
                    w-auto max-w-full
                    object-contain
                  "
                  loading="eager"
                />
                <span className="opacity-80 whitespace-nowrap">th visitor</span>
              </div>
